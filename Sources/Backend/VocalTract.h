...
public:
  ...
  int setPiriformFossa(double piriformFossaLength_cm, double piriformFossaVolume_cm3);
  int setSubglottalCavity(double subglottalCavityLength_cm);
  int setNasalCavity(double nasalCavityLength_cm);
