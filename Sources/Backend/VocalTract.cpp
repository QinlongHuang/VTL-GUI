...
// 梨状窝
int VocalTract::setPiriformFossa(double piriformFossaLength_cm, double piriformFossaVolume_cm3)
{
  // TODO: boundary condition check 
  bool bch = true;
  if (bch)
  {
    anatomy.piriformFossaLength_cm = piriformFossaLength_cm;
    anatomy.piriformFossaVolume_cm3 = piriformFossaVolume_cm3;
    return 0;
  }
  else
  {
...
// 声门下腔体（气管？）
int VocalTract::setSubglottalCavity(double subglottalCavityLength_cm)
{
  // TODO: boundary condition check 
  bool bch = true;
  if (bch)
  {
    anatomy.subglottalCavityLength_cm = subglottalCavityLength_cm;
    return 0;
  }
  else
  {
...
// 鼻腔
int VocalTract::setNasalCavity(double nasalCavityLength_cm)
{
  // TODO: boundary condition check 
  bool bch = true;
  if (bch)
  {
    anatomy.nasalCavityLength_cm = nasalCavityLength_cm;
    return 0;
  }
  else
  {
...
void VocalTract::calcCrossSections()
{
  ...
  // So why do you set VO smaller than 0 ?????????
