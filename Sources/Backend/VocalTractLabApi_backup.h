...
C_EXPORT vector<double> vtlSynthAudio(vector<double> tractParams, vector<double> glottisParams, int numFrames, 
  int frameStep_samples);

C_EXPORT int vtlSetAnatomyParams(double *anatomyParams);

C_EXPORT int vtlGetAnatomyParams(double *ana_params);

C_EXPORT int vtlSaveVocalTractVideoFrame(double duration_s, double *tractParams, const char *folderName);
